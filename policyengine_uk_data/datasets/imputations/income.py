...
def impute_over_incomes(
    ...
    dataset.household["mortgage_interest_repayment"] = dataset.household["mortgage_interest_repayment"] * adjustment_factor
    dataset.household["mortgage_capital_repayment"] = dataset.household["mortgage_capital_repayment"] * adjustment_factor
