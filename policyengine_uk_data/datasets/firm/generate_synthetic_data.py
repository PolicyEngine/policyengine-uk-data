...
class SyntheticFirmGenerator:
    ...
    def load_data(self) -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame, pd.DataFrame, int]:
        ...
        ons_employment_path = project_root / 'ONS_UK_business_data' / 'firm_employment.csv'
        hmrc_turnover_path = project_root / 'HMRC_VAT_annual_statistics' / 'vat_population_by_turnover_band.csv'
        hmrc_sector_path = project_root / 'HMRC_VAT_annual_statistics' / 'vat_population_by_sector.csv'
        vat_liability_sector_path = project_root / 'HMRC_VAT_annual_statistics' / 'vat_liability_by_sector.csv'
        vat_liability_band_path = project_root / 'HMRC_VAT_annual_statistics' / 'vat_liability_by_turnover_band.csv'
